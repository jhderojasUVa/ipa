          ...
          <div class="medium-4 cell">
            <div class="card">
              ...
              <!--<div style="width: 100%; height: 100%;background: url(<?=$ultimos_6[$i]["imagen"]?>) no-repeat center center; background-size: 100%;"><div style="width: 100%; height: 200px;"></div></div>-->
							<div style="width: 100%; height: 100%;background: url(<?=base_url()?>img_pisos/<?=$ultimos_6[$i]["idpiso"]?>/<?=$ultimos_6[$i]["imagen"]?>) no-repeat center center; background-size: 100%;"><div style="width: 100%; height: 200px;"></div></div>
