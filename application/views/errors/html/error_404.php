...
<body>
  ...
  <div class="grid-container error">
    <div class="grid-y">
      ...
      <div class="cell">
        <p><strong>Lo sentimos</strong> ha ocurrido un error. <strong>Parece ser que estas intentando ver algo que ya no existe.</strong></p>
        ...
        <h3>Ayudame <small>Que puedo hacer</small></h3>
        <p>Aun con todo eso, si necesitas ayuda puedes <a href="http://<?=$_SERVER['SERVER_NAME']?>/index.php/buscar/busquedas" role="link">usar nuestro buscador</a> o <a href="mailto:ipa.asuntos.sociales@uva.es?subject=Error en la web">enviarnos un correo</a> indicandonos el problema que has encontrado y que es lo que querias realizar.</p>
      </div>
      <div class="cell">
        <form action="http://<?=$_SERVER['SERVER_NAME']?>/index.php/buscar/busquedas">
          <div class="grid-x">
